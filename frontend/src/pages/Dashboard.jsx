...
const Dashboard = () => {
  const [startups, setStartups] = React.useState([
    ...
    {
      name: "NewsOne",
      desc: "A smart news aggregator that categorizes and recommends news based on user taste.",
    },
  ]);
  ...
  return (
    <div className="overflow-y-auto w-full h-full px-4 py-10 text-black">
      ...
      <div className="flex flex-col gap-5">
        ...
        <div
          onClick={() => setIsDialogOpen(true)}
          className="cursor-pointer text-sm text-[#020202aa] font-semibold hover:text-black w-fit mt-4"
        >
          Add Startup +
        </div>
      </div>
