    ...
    >
      ...
      <div className="flex justify-between items-start mb-3">
        <div>
          ...
          <p className="text-xs text-gray-500 mt-1 leading-5">{startUpDesc}</p>
        </div>
        <MoreHorizontal className="w-5 h-5 text-gray-700" />
      </div>
      ...
      <div className="flex gap-3 mt-auto pt-4">
        ...
        <NavLink className="bg-[#FBC02D] text-xs text-black hover:text-black hover:bg-[#fbc12dd3] px-4 py-2 rounded-full shadow font-medium">
          Tasks
        </NavLink>
