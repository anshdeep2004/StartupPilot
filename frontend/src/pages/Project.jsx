    ...
    <div className="overflow-y-auto w-full h-full px-10 py-8 text-black">
      ...
      <div className="mt-8 space-y-6">
        ...
        <div className="p-4 rounded-xl bg-white/10 backdrop-blur-md border border-white/20 shadow-lg">
          ...
          <div className="w-full h-3 rounded-full bg-white/20 overflow-hidden">
            <div
              className="h-full rounded-full bg-gradient-to-r from-[#7C3AED] via-[#C084FC] to-[#F472B6] transition-all duration-700"
              style={{ width: "70%" }}
            ></div>
          </div>
        </div>
        ...
        <div className="p-4 rounded-xl bg-white/10 backdrop-blur-md border border-white/20 shadow-lg">
          ...
          <div className="w-full h-3 rounded-full bg-white/20 overflow-hidden">
            <div
              className="h-full rounded-full bg-gradient-to-r from-[#F97316] via-[#FB923C] to-[#FDE047] transition-all duration-700"
              style={{ width: "45%" }}
            ></div>
          </div>
        </div>
        ...
        <div className="p-4 rounded-xl bg-white/10 backdrop-blur-md border border-white/20 shadow-lg">
          ...
          <div className="w-full h-3 rounded-full bg-white/20 overflow-hidden">
            <div
              className="h-full rounded-full bg-gradient-to-r from-[#06B6D4] via-[#3B82F6] to-[#9333EA] transition-all duration-700"
              style={{ width: "90%" }}
            ></div>
          </div>
        </div>
      ...
      {isDialogOpen && (
        <div className="fixed inset-0 bg-black bg-opacity-40 flex items-center justify-center px-4 z-[9999]">
          <div className="bg-gradient-to-r  from-[#C7D2FE] to-[#E9D5FF]  p-6 rounded-lg shadow-xl w-[400px] animate-fadeIn z-[10000]">
            ...
            <label className="block text-sm font-medium mb-1 bg-gradient-to-r  from-[#C7D2FE] to-[#E9D5FF] border-gray-600 text-gray-500">
              Start Date
            </label>
            <input
              type="date"
